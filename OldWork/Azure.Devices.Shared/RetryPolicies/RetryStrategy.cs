...
namespace Microsoft.Azure.Devices.Client.TransientFaultHandling
{
    ...
    internal abstract class RetryStrategy
    {
        ...
        /// </summary>
        public static readonly TimeSpan DefaultClientBackoff = TimeSpan.FromSeconds(10);
        ...
        /// </summary>
        public static readonly TimeSpan DefaultRetryIncrement = TimeSpan.FromSeconds(1);
