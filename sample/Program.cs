...
try
{
    ...
    while (!ShoudIStop)
    {
        ...
        var isReceived = azureIoT.SendMessage($"{{\"Temperature\":{values.Temperature.DegreesCelsius},\"Pressure\":{values.Pressure.Hectopascals}}}", new CancellationTokenSource(5000).Token);
